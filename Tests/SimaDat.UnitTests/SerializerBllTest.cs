...
namespace SimaDat.UnitTests
{
    ...
    public class SerializerBllTest
    {
        ...
        public void TestInit()
        {
            ...
            _locationHome.Doors = new List<Location.Door> { new Location.Door { Direction = Directions.North, LocationToGoId = _locationPub.LocationId } };
        }
        ...
        public void DeserializeLocation_CheckDirection_ForDoor()
        {
            ...
            location.Doors.Single().Direction.Should().Be(Directions.SouthEast);
        }
        ...
        {
            var door = new Location.Door { Direction = Directions.NorthWest, LocationToGoId = 666 };
